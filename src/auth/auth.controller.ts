...
export class AuthController {
  ...
  @ApiResponse({ status: 201, description: 'User registered with access & refresh tokens' })
  ...
  register(
    ...
    return this.authService.register(dto.email, dto.password, dto.role, userAgent, ip);
  }
