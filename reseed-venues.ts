...
async function reseedVenues() {
  console.log('🔄 Re-seeding venues with complete data...\n');
  ...
  if (!vendor) {
    console.error('❌ Demo vendor not found. Run seed script first.');
    process.exit(1);
  }
  ...
  console.log('🗑️  Deleted existing venues\n');
  ...
  console.log('\n✨ All venues re-seeded with unique images!\n');
}
